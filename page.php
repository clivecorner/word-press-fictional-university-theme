<?php
  ...
  <div class="container container--narrow page-section">
    <?php 
    $theParent = wp_get_post_parent_id(get_the_ID()); //If the page has a parent ie is a child page then we get the parent ID
    if($theParent){ ?>
    ...
    <div class="page-links">
      ...
      <ul class="min-list">
        <?php 
          if($theParent){ //Is a child page
            $child_of = $theParent;
          }else{ // Is a parent page
            $child_of = get_the_ID();
          }
        ?>
        <?php wp_list_pages(
